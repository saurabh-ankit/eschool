    ...
    public function index()
    {
        ...
        if (isset($_POST['search'])) {
           // print_r($_POST);die;
            ...
            $this->data['stafflistindivisual'] = $this->payroll_model->getEmployeePaymentListindivisual($branch_id, $staff_role, $this->data['month'], $this->data['year'],$loginuser_id);
                // echo "<pre>";
                // print_r( $this->data['stafflist']);die;
             $this->db->select('staff_id')->from("staff")
                                ->where('id=',$loginuser_id);
             $this->data['staffid'] = $this->db->get()->result();
             //print_r($this->data['staffid']);die;
