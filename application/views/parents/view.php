					...
					<table class="table table-bordered table-hover table-condensed mb-none table-export">
						...
						<tbody>
							...
							<?php } ?>
								...
								$childsresult = $this->parents_model->childsResult($row->id);
								if ($childsresult[0]['fullname']) {
								print_r($childsresult[0]['fullname'].",".$childsresult[0]['class_name'].",".$childsresult[0]['section_name']);
								
								  ?> <a style="float: right;" class="text-muted mail-subj" href="<?php echo base_url('student/profile/' . $childsresult[0]['id']);?>" target="_blank"><?=translate('profile')?></a>
								  <?php } else{
								  	echo "No Student Find";
								  } ?>
