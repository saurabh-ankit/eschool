        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    get_permission('class_timetable', 'is_view')||get_permission('attachments', 'is_view') ||
                    get_permission('attachment_type', 'is_view')||get_permission('homework', 'is_view') ||
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'classes' ||
                                                        $main_menu == 'sections' ||
                                                            $main_menu == 'timetable' ||
                                                                $main_menu == 'subject'|| $main_menu == 'attachments'|| $main_menu == 'homework' ) echo 'nav-expanded nav-active';?>">
                        <a>
                    ...
                    ?>
                    <!-- exam master -->
                    <li class="nav-parent <?php if ($main_menu == 'exam' || $main_menu == 'mark' || $main_menu == 'exam_timetable'|| $main_menu == 'transfer') echo 'nav-expanded nav-active';?>">
                        <a>
