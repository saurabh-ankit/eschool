						...
						<div id="<?php echo $row['id']; ?>" class="accordion-body collapse">
							<div class="panel-body">
								<div class="row">
									...
									<div class="col-md-8">
										<?php if ($row['ev_status'] == 'u' || $row['ev_status'] == '') { ?>
										<form action="<?=base_url('userrole/submithomework/')?>" method="POST" enctype="multipart/form-data">
										...
										<i class="fas fa-cloud-upload-alt"></i>
										  <input type="submit" value="Upload homework"  name="Upload">
										</div>
										</div>
										</form>
										<?php }?>
