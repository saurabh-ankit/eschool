...
<div class="row">
    <div class="col-md-12">
                    ...
                    <?php } else { ?>
                    	...
                    	<div class="col-md-3 mb-sm">
                            <div class="form-group">
                                  ...
                                  <input type="hidden" name="loginuser_id" value="<?php echo(get_loggedin_user_id());?>">
                                  <input type="hidden" name="staff_role" value="<?php echo(loggedin_role_id()); ?>">
        ...
        <?php endif; ?>
         <?php if(isset($stafflistindivisual)): 
            //print_r($staffid[0]->staff_id);

            ?>
            <section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
                <header class="panel-heading">
                    <h4 class="panel-title"><?php echo translate('your') . " " . translate('salary'); ?></h4>
                </header>
                <div class="panel-body">
                    <div class="mb-sm mt-xs">
                        <table class="table table-bordered table-hover table-condensed " >
                            ...
                            <tbody>
                                <?php foreach ($stafflistindivisual as $row): ?>
                                    <?php if ($staffid[0]->staff_id == $row->staff_id ) { ?>
                                    ...
                                    <td>
                                     ...
                                     <td class="min-w-c">
                                        <?php if($status == 'paid'): ?>
                                            <a href="<?php echo base_url('payroll/invoice/'.$row->salary_id.'/'.$row->salary_hash); ?>" class="btn btn-default btn-circle"><i class="fas fa-eye"></i> <?php echo translate('payslip'); ?></a>
                                         <?php else: ?>
                                            <i class="far fa-credit-card"></i> <?php echo translate('Awaiting'); ?>
                                            <!-- <a target="_blank" href="<?php echo base_url('payroll/create/' . $row->id . '/' . $month . '/' . $year); ?>" class="btn btn-default btn-circle"><i class="far fa-credit-card"></i> <?php echo translate('pay_now'); ?></a> -->
                                         <?php endif; ?>
                                    </td> 
                                     <?php } ?>
