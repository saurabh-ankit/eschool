				...
				<div class="row mb-md">
					...
					<div class="col-md-<?php echo $widget; ?> mb-sm">
						<div class="form-group">
							...
							<!-- <select name="category_id" class="form-control select2-hidden-accessible" data-plugin-selecttwo="" data-width="100%" id="category_id" data-minimum-results-for-search="Infinity" tabindex="-1" aria-hidden="true"><option value="">Select</option><option value="1">Gen</option><option value="2">OBC</option><option value="4">SC</option><option value="5">ST</option></select> -->
							 <?php
