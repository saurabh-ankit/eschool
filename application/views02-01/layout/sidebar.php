        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    ?>
                    <!-- setting -->
                    <li class="nav-parent <?php if ($main_menu == 'settings' || $main_menu == 'school_m'||$sub_page == 'branch/logo' ) echo 'nav-expanded nav-active';?>">
                        <a>
                        ...
                        <ul class="nav nav-children">
                            ...
                            <li class="<?php if($main_menu == 'school_m') echo 'nav-active';?>">
                             ...
                             <?php } if (is_superadmin_loggedin()) { ?>
                            <li class="<?php if ($sub_page == 'branch/logo') echo 'nav-active';?>">
                                <a href="<?=base_url('branch/logo')?>">
                                    <span><i class="fas fa-caret-right" aria-hidden="true"></i><?=translate('branch_logo')?></span>
                                </a>
                            </li>
                            <?php } if (is_superadmin_loggedin()) { ?>
