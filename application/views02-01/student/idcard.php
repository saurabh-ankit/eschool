					...
					<div class="col-md-4 col-lg-4 col-xl-3 idcard-col">
						...
						<div class="id-card-holder">
							<header class="id-card-heading">
								<center><img class="img-fs" src="<?=base_url('uploads/app_image/printing-logo.png')?>" alt="RamomThakur Img" /></center>
							</header>
							<div class="id-card">
								<div class="photo">
...
<script type="text/javascript">
	...
	function printElem(elem)
	{
	    ...
	    frameDoc.document.write('<link rel="stylesheet" href="' + base_url + 'assets/css/School.css">');
