     ...
     public function logo(){
              if ($this->input->post('submit') == 'logo') {
                 $branchId = $this->input->post('branchid');
                  move_uploaded_file($_FILES['text_logo']['tmp_name'], 'uploads/app_image/'.$branchId.'logo-small.png');

              }

            $this->data['data'] = "Ramom";
            $this->data['title'] = translate('branch_logo');
            $this->data['sub_page'] = 'branch/logo';
            $this->data['main_menu'] = 'branch';
            $this->load->view('layout/index', $this->data);
     }
